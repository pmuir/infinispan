...
import org.infinispan.nearcache.config.AddressCache;
...
public class AddressCacheManager {
   ...
   @Inject @AddressCache
   private Cache<DefaultCacheKey, Address> cache;

   public String[] getCachedValues() {
      List<String> values = new ArrayList<String>();
      for (Map.Entry<DefaultCacheKey, Address> entry : cache.entrySet())
