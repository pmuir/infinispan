...
public class StateRetrievalConfigurationBuilder extends AbstractClusteringConfigurationChildBuilder<StateRetrievalConfiguration> {
   ...
   StateRetrievalConfiguration create() {
      return new StateRetrievalConfiguration(alwaysProvideInMemoryState, fetchInMemoryState, initialRetryWaitTime, logFlushTimeout, maxNonPorgressingLogWrites, numRetries, retryWaitTimeIncreaseFactor, logFlushTimeout);
   }
